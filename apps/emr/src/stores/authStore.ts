  ...
  persist(
    (set, get) => ({
      ...
      login: async (email: string, password: string) => {
        // Call the auth service login endpoint (proxied via Vite dev server)
        ...
        // Store tokens immediately so the subsequent /me call is authenticated
    ...
    {
      name: 'ph-auth',
      // Use sessionStorage: tokens are cleared when the browser tab is closed
